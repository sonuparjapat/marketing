...
adminRouter.get('/', adminAuth, checkPermission('client_logos.read'), ctrl.adminList);
adminRouter.get('/:id', adminAuth, checkPermission('client_logos.read'), ctrl.adminGetOne);
adminRouter.post('/', adminAuth, checkPermission('client_logos.create'), ctrl.createLogo);
adminRouter.put('/:id', adminAuth, checkPermission('client_logos.update'), ctrl.updateLogo);
