...
adminRouter.get('/', adminAuth, checkPermission('blog_categories.view'), ctrl.adminList);
adminRouter.get('/:id', adminAuth, checkPermission('blog_categories.view'), ctrl.adminGetOne);
adminRouter.post('/', adminAuth, checkPermission('blog_categories.create'), ctrl.createCategory);
adminRouter.put('/:id', adminAuth, checkPermission('blog_categories.edit'), ctrl.updateCategory);
